...
const lines = [
  "begin;",
  "",
  "insert into public.portfolio_snapshots (portfolio_id, title, subtitle, week, report_date, summary, storyline, visual_references, project_buckets, rules, timeline_policy, source_updated_at)",
  "values (",
