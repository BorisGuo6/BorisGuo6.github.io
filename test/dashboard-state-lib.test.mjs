...
assert.deepEqual(
  vercelConfig.rewrites?.find((rewrite) => rewrite.source === "/api/dashboard/project-create"),
  {
    source: "/api/dashboard/project-create",
    destination: "/api/dashboard/project-table-row?operation=project-create",
  },
